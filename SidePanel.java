...
public class SidePanel extends JPanel {
	...
	public void paintComponent(Graphics g) {
		...
		g.setFont(SMALL_FONT);
		g.drawString("Move Left - Left Arrow", SMALL_INSET, offset += TEXT_STRIDE);
		g.drawString("Move Right - Right Arrow", SMALL_INSET, offset += TEXT_STRIDE);
		g.drawString("Rotate Anticlockwise", SMALL_INSET, offset += TEXT_STRIDE);
		g.drawString("Rotate Clockwisec- UP Arrow", SMALL_INSET, offset += TEXT_STRIDE);
		g.drawString("Drop - Down Arrow", SMALL_INSET, offset += TEXT_STRIDE);
		g.drawString("Pause Game", SMALL_INSET, offset += TEXT_STRIDE);
